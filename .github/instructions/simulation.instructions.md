...
3. The app's main target device is mobile devices, so the UI/UX should be optimized for mobile screens. However, it should also work well on desktop screens.
