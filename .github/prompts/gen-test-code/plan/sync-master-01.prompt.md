...
2. Save your review results as $REVIEW_FILE under $REVIEW_DIR folder. If no gaps are found (=the current $SOURCE is fully consistent with $TARGET), you can write the review results as they are ("no gaps are found").

3. Given the $REVIEW_FILE review, modify the $TARGET to make it fully-consistent with the $SOURCE.
