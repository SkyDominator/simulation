...
After that, repeat the following steps (1~4) until no gaps between my current codebase ([frontend](/src/frontend/*) [backend](/src/backend/*)) and the [SSD](/.github/copilot-instructions.md) are found after revewing the [SSD](/.github/copilot-instructions.md) (Repeat the following steps until the review result says "no gaps are found") .

Here are the detailed steps:

1. Review [SSD](/.github/copilot-instructions.md) and find any gaps (differences) when compared to my current codebase.
...
Read the [SSD](/.github/copilot-instructions.md) again and find the remaining gaps (differences) when compared to my current codebase.