Implement new codes or modify existing codes in the codebase (`/src/**`) by exactly following the implementation plan described in `/.memo/CE/plans/2025-09-16/test-code/test-code.md`.

# Important notes

1. Install pre-requisite packages or dependencies if necessary.
