...
- Fully understand the implementation made in the current conversation (context) so far.
- Explore causes of explicit/potential bugs, security or performance issues.

# The research question

Fully explain the implementations made in the current conversation.

# The outcome of research

- Create a `/.memo/CE/2025-09-15-impl-research-result.md` file to report your research results.
