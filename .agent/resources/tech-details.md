...
- Production: `simulation.LOLCLUB.com`
- Staging: `staging-simulation.LOLCLUB.com`
...
- `https://simulation.LOLCLUB.com` (production)
- `https://staging-simulation.LOLCLUB.com` (staging)
...
5. **E2E Tests** (job: `test-e2e`, optional):
   - Playwright with `BASE_URL=https://staging-simulation.LOLCLUB.com`
