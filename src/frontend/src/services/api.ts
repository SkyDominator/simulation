...
export const api = {
  ...
  listPrivacyPolicies: (token: string) =>
    defaultApiService.listPrivacyPolicies(token),
  ...
  getUserConsents: (user_hash: string) =>
    defaultApiService.getUserConsents(user_hash),
  sendOtp: (name: string, phone_number: string) =>
    defaultApiService.sendOtp(name, phone_number),
