...
export const MOCK_RESULTS = {
  ...
  COMPLEX: {
    history: [
      ...
      { company_round: 3, investor_count: 4, total_payment: 4000000, cumulative_net_profit: -120000 },
      { company_round: 4, investor_count: 8, total_payment: 8000000, cumulative_net_profit: 200000 },
      { company_round: 5, investor_count: 16, total_payment: 16000000, cumulative_net_profit: 1200000 }
    ],
    summary: {
      total_rounds: 5,
 ...
 */
export function generateTestSimulation(planId: keyof typeof TEST_SIMULATIONS, overrides: Partial<any> = {}) {
 ...
 */
export function createErrorResponse(code: number, message: string, details?: any) {
  return {
    success: false,
    error: {
      code,
